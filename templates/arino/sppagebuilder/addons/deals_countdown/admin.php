...
SpAddonsConfig::addonConfig(
	array(
		'type'=>'content',
		'addon_name'=>'sp_deals_countdown',
		'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_DEALS_COUTNDOWN'),
		'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_DEALS_COUTNDOWN_DESC'),
		'category'=>'Content',
		'attr'=>array(
			'general' => array(
				...
				'full_link'=>array(
					'type'=>'text',
					'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_DEALS_COUNTDOWN_FULL_LINK'),
					'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_DEALS_COUNTDOWN_FULL_LINK_DESC'),
					'std'=>  ''
				),
				'image'=>array(
					'type'=>'media',
