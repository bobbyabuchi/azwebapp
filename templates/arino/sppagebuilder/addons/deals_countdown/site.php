...
class SppagebuilderAddonDeals_countdown extends SppagebuilderAddons{
	...
	public function render() {
		...
		$full_link 		= (isset($this->addon->settings->full_link) && $this->addon->settings->full_link) ? $this->addon->settings->full_link : '';
		...
		$output  = '';
		$output .= '<div class="sppb-addon sppb-addon-countdown deals-counter ' . $class . '">';
		if($full_link){
			$output .= '<a href="'. $full_link .'" class="full-link"></a>';
		}
	...
	public static function getTemplate(){
		...
		<div class="sppb-addon sppb-addon-countdown deals-counter {{ data.class }}">
			<# if(!_.isEmpty(data.full_link)){ #>
				<a href="{{data.full_link}}" class="full-link"></a>
			<# } #>
			<div class="countdown-text-wrap">
				<# if( !_.isEmpty( data.title ) ){ #><{{ data.heading_selector }} class="sppb-addon-title sp-inline-editable-element" data-id={{data.id}} data-fieldName="title" contenteditable="true">{{ data.title }}</{{ data.heading_selector }}><# } #>
				<img class="sppb-img-responsive" src="{{data.image}}" alt="{{data.alt_text}}" title="{{data.title}}">
			</div>
