...
/**
 * @package J2Store
 * @copyright Copyright (c)2014-19 Ramesh Elamathi / J2Store.org
		...
		<div id="add-to-cart-<?php echo $this->product->j2store_product_id; ?>" class="j2store-add-to-cart">
			...
			<div class="arino-qty-wrap">
				<span class="product-qty-wrap">
					<span><?php echo JText::_('J2STORE_PRODUCT_QTY_TITLE')?></span>
			...
			<input data-cart-action-always="<?php echo JText::_('J2STORE_ADDING_TO_CART'); ?>" data-cart-action-done="<?php echo $cart_text; ?>" data-cart-action-timeout="1000" value="<?php echo $cart_text; ?>" type="submit" class="j2store-cart-button <?php echo $this->params->get('addtocart_button_class', 'btn btn-primary');?>" />
