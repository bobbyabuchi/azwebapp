    ...
    <div class="j2store-mainimage">
        ...
        <?php if($main_image &&  JFile::exists(JPATH_SITE.'/'.$main_image)):?>
            ...
            <span class="<?php echo $class; ?>" id="j2store-item-main-image-<?php echo $this->product->j2store_product_id; ?>">
		  	 <img itemprop="image"
                  alt="<?php echo (!empty($this->product->main_image_alt)) ? $this->product->main_image_alt : $this->product->product_name; ?>"
    ...
    if(count($additional_images)) :
        ...
        <div class="j2store-product-additional-images">
            ...
            <ul class="additional-image-list popup-gallery">
                    ...
                    if(JFile::exists(JPATH_SITE.'/'.$image)):
                        ...
                        <li href="<?php echo $image_src;?>">
                            <img 
                                 ...
                                 alt="<?php echo (isset($additional_images_alt[$key]) && !empty($additional_images_alt[$key])) ? $additional_images_alt[$key] : $this->product->product_name; ?>"
                                 title="<?php echo $this->product->product_name ;?>"
                ...
                <?php if($main_image &&  JFile::exists(JPATH_SITE.'/'.$main_image)):?>
                    <li>
                        <img id="additial-main-image-<?php echo $this->product->j2store_product_id; ?>"
                             alt="<?php echo (!empty($this->product->main_image_alt)) ? $this->product->main_image_alt : $this->product->product_name; ?>"
                             title="<?php echo $this->product->product_name ;?>"
