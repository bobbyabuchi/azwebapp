...
<?php if($this->params->get('item_show_product_manufacturer_name', 1) && !empty($this->product->manufacturer)): ?>
	<span class="manufacturer-brand">
		<span class="brand-txt"><?php echo JText::_('J2STORE_PRODUCT_MANUFACTURER_NAME'); ?> :</span>

		<span class="brand-name"><?php if(isset($this->product->brand_desc_id) && !empty($this->product->brand_desc_id)):?>
