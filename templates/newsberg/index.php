...
if($custom_style || !$preset)
{
    $scssVars = array(
        ...
        'text_color_primary' => $this->params->get('text_color_primary'),
        'bg_color' => $this->params->get('bg_color'),
        'link_color' => $this->params->get('link_color'),
        'link_color_primary' => $this->params->get('link_color_primary'),
        'link_color_secondary' => $this->params->get('link_color_secondary'),
        'link_hover_color' => $this->params->get('link_hover_color'),
        'link_color_hover_primary' => $this->params->get('link_color_hover_primary'),
        'link_color_hover_secondary' => $this->params->get('link_color_hover_secondary'),
...
// load custom font two
if ($this->params->get('enable_custom_font_two') && $this->params->get('custom_font_two_selectors')) {
    $webfonts = array();
    $webfonts[$this->params->get('custom_font_two_selectors')] = $this->params->get('custom_font_two');
