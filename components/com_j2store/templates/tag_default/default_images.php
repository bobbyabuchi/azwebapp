	      ...
	      ?>
		   <?php if($main_image &&  JFile::exists(JPATH_SITE.'/'.$main_image)):?>
			...
			<?php endif;?>	
		  	 ...
		  	 <img itemprop="image"
                  alt="<?php echo (!empty($this->product->main_image_alt)) ? $this->escape($this->product->main_image_alt) : $this->escape($this->product->product_name); ?>" title="<?php echo $this->escape($this->product->product_name) ;?>"
